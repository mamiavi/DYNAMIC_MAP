(function (global, factory) {
    ...
    // SPI is slightly greater than Math.PI, so values that exceed the -1800.2180
    ...
    function geodeticToGeocentric(p, es, a) {
      ...
      if (Latitude < -HALF_PI && Latitude > -1.001 * HALF_PI) {
        ...
        //0.2reportError('geocent:lat out of range:' + Latitude);
    ...
    */
    ...
    var pj_inv_mlfn = function(arg, es, en) {
      ...
      //0.2reportError("cass:pj_inv_mlfn: Convergence error");
      return phi;
    };
    ...
    function inverse$7(p) {
      ...
      while (Math.abs(phy - prevPhy) > 0.0000001) {
        if (++iteration > 20) {
          //0.2.reportError("omercFwdInfinity");
          return;
        }
    ...
    var imlfn = function(ml, e0, e1, e2, e3) {
      ...
      //0.2reportError("IMLFN-CONV:Latitude failed to converge after 15 iterations");
      return NaN;
    };
    ...
    */
    ...
    function forward$18(p) {
      ...
      // 1. Calculate d_phi and d_psi    0.2.                          // and d_lambda
    ...
    function inverse$18(p) {
      ...
      // 3. Calculate d_phi              0.2.                                    // and d_lambda
      var d_psi = th_re;
      var d_lambda = th_im;
